# AmberBeam documentation

[Deutsch](README.de.md)

Short pages about the things that are not obvious. The program itself tries
to explain what it is doing as it does it; this is for the questions that
come before that, or afterwards.

| | |
|---|---|
| [Getting started](getting-started.md) | Connecting, moving files, the queue |
